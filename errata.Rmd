...
\begin{align*}
\lambda &= \dfrac{SS_{Hypothesis}}{\sigma^2}\\
&=\frac{\sum_{i=1}^a n_i (\mu_{i\bullet} -
\bar{\mu}_{\bullet\bullet})^2}{\sigma^2} \\
&= \dfrac{ 6\cdot(390-405)^2 + 6\cdot(405-405)^2 + 12\cdot(415-405)^2 + 12\cdot(410-405)^2}{14^2} \\
&= \dfrac{2635}{14^2} = 13.3929.
\end{align*}
...
&=\frac{\sum_{i=1}^a n_i (\mu_{i\bullet} -
\bar{\mu}_{\bullet\bullet})^2}{\sigma^2} \\
&= \dfrac{ 6\cdot(390-407.5)^2 + 6\cdot(405-407.5)^2 + 12\cdot(415-407.5)^2 + 12\cdot(410-407.5)^2}{14^2} \\
&= \dfrac{2635}{14^2} = 13.3929.
\end{align*}
